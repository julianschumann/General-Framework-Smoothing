...
old = 'Roundabout--t0=all01_ss--dt=0.10_nI=15m15_nO=20m20_EC--max_000--agents_V--identi_split_0_pert=0'
new = 'Roundabout--t0=crit__ss--dt=0.10_nI=15m15_nO=20m20_EC--max_000--agents_0--identi_split_0_pert=0'
